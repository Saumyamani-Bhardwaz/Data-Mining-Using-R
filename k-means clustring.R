...
plot(iris_data[c("Sepal.Length", "Sepal.Width")], col = kmeans.re$cluster)
plot(iris_data[c("Sepal.Length", "Sepal.Width")], col = kmeans.re$cluster, main = "K-means with 3 clusters")
